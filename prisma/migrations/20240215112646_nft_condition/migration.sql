...
CREATE TABLE "NFTLockCondition" (
    ...
    CONSTRAINT "NFTLockCondition_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "NFTLockCondition_postId_idx" ON "NFTLockCondition"("postId");
...
-- AddForeignKey
ALTER TABLE "NFTLockCondition" ADD CONSTRAINT "NFTLockCondition_postId_fkey" FOREIGN KEY ("postId") REFERENCES "Post"("id") ON DELETE CASCADE ON UPDATE CASCADE;
